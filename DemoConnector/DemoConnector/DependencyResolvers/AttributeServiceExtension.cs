...
namespace DemoConnector.DependencyResolvers
{
    /// <summary>
    ...
    public static class AttributeServiceExtension
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static ServiceCollection RegisterAttributeServices()
        {
            var assembly = typeof(Gateway).Assembly;// Assembly.GetExecutingAssembly(assembliesToBeScanned);
